    ...
    return (
        <div className='flex gap-4 items-center justify-center'>
            <label htmlFor={styles.hordeRadio}>
                <input type="radio" id={styles.hordeRadio} className={styles.radioInput} value={FRACTION_OPTIONS.HORDE}
                ...
                <span className={styles.radioTile}>
                    <img className={styles.radioIcon} src={horde_img.src} alt='Fraction: Horde'></img>
                    <span className={styles.radioLabel}>Horde</span>
                </span>
            </label>

            <label htmlFor={styles.allianceRadio}>
                <input type="radio" id={styles.allianceRadio} className={styles.radioInput} value={FRACTION_OPTIONS.ALLIANCE}
                    checked={fractionChecked === FRACTION_OPTIONS.ALLIANCE}
                    name="fraction"
                    onChange={() => setFractionChecked(FRACTION_OPTIONS.ALLIANCE)} />
                <span className={styles.radioTile}>
                    <img className={styles.radioIcon} src={alliance_img.src} alt='Fraction: alliance'></img>
