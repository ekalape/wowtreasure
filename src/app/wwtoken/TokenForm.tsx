...
export default function TokenForm() {
  ...
  async function submitTokenAmount(
    prevState: TokenAmountResponse | null,
    formData: FormData,
  ...
  return (
    <>
      ...
      <form
        action={formAction}
        className='w-full  min-w-80  lg:col-span-2 border-2 border-background_alt p-4 rounded-lg flex flex-col justify-start gap-5'>
        <h2 className='mt-2'>Add token cost</h2>
        <Input placeholder='0' ref={inputRef} type='number' name={'tokenform'} defaultValue='' />
